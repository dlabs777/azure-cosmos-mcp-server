...
function truncateLongValues(value: any): any {
...
async function sampleItem(params: any) {
  try {
    ...
    // Process resources to truncate long values
    const truncatedResources = resources.map(item => {
      const truncatedItem: Record<string, any> = {};
